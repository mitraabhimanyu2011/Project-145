...
# Define the function
def show():
    id_value = 47204629465
    print(type(id_value))
    
    name = "Abhimanyu Mitra"
    print(type(name))
    ...
    vehicle_type = ["Tesla Model 3 2020", "Acura RDX 2019"]
...
label_vehicle_no_window = canvas.create_window(410, 180, anchor=CENTER, window=label_vehicle_type)
canvas.pack()
